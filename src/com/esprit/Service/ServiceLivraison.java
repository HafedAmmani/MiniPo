...
//	    PreparedStatement st= con.prepareStatement("select * from livraison liv,commande c WHERE c.idcmd=liv.idc ORDER BY c.datec ASC");
    ...
    public ObservableList<Livraison> getLivraisonRelatedToLivreur(Integer idLivreur) {
...
//	    PreparedStatement st= con.prepareStatement("select * from livraison liv,commande c WHERE c.idcmd=liv.idc ORDER BY c.datec ASC");
    ...
    public ObservableList<Livraison> getLiv() {
        ...
        try {
            PreparedStatement st = con.prepareStatement("select *, c.refC, u.username from livraison l , commande c, user u WHERE l.idc=c.idcmd and l.id=u.id ORDER BY idliv");
//	    PreparedStatement st= con.prepareStatement("select * from livraison liv,commande c WHERE c.idcmd=liv.idc ORDER BY c.datec ASC");
            ResultSet rs = st.executeQuery();
            while (rs.next()) {
                Integer idliv = rs.getInt("idliv");
    ...
    public boolean updateLiv(String etat, String id) throws SQLException {
